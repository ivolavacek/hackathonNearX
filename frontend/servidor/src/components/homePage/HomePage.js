        ...
        <>
            <div className={`total ${mode}`}>
                <div className={`titulo ${mode}`}>
                    ...
                    <div className="texto2">Conecte sua Wallet para ter acesso as nossas funcionalidades!</div>
                </div>
                <div class="container">
                    {/* <div class="square">
                    ...
                    <div class="square"><p className='paragrafos'>Faça o Faucet do Token GIV, colete o SBT (Soulbond Token) e comece agora a utilizar a plataforma de cursos!</p></div>
                    <div class="square"><p className='paragrafos'>Você sabia que um Soulbond Token se diferencia dos NFTs pela sua conexão única e intransferível?</p></div>
